...
export const routes: Routes = [
    ...
    { path: 'assessment/add', title: 'App New Assessment', component: AssessmentEditCreateComponent },
    { path: 'assessment/:id', title: 'App Assessment Detail', component: AssessmentComponent },
    { path: 'assessment/:id/edit', title: 'App Edit Assessment', component: AssessmentEditCreateComponent },
    { path: 'registry/add', title: 'App Registry Page', component: RegistryComponent },
